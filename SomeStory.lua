...
local exec = tostring(identifyexecutor())
--updatefix
local Window = Uilib.new(true, "                         "..namegame.." ( "..display .." ) 🗺️ Story: " .. Settings.GemFramed .. " / " .. Settings.GemtoFarm .." 🗺️")
