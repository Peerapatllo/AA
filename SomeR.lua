...
local exec = tostring(identifyexecutor())
--updatefix
local Window = Uilib.new(true, "                         "..namegame.." ( "..display .." ) 💀 KillerCoin: " .. Settings.GemFramed .. " / " .. Settings.GemtoFarm .." 💀")
