...
local exec = tostring(identifyexecutor())
--updatefix
local Window = Uilib.new(true, "                         "..namegame.." ( "..display .." ) 🧙 Byu: " .. Settings.GemFramed .. " / " .. Settings.GemtoFarm .." 🧙")
