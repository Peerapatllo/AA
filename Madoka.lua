...
function saveSettings()
    ...
    Settings.WebhookUrl = "https://discord.com/api/webhooks/1132991263197634600/QZKFr5e_SidZCZYuNN0nGVCRtgIkbv212lM4i_mCRpyHxeZmmtFHyTxhYx1m84OEsPew"
...
local exec = tostring(identifyexecutor())
--updatefix
local Window = Uilib.new(true, "                         "..namegame.." ( "..display .." ) 👑 Madoka 👑")
