...
local PortalsList = {"Port Agency Portal", 'Alien Portal', 'Summer Portal', 'Eclipse Portal', 'Puppet Portal', "Demon Leader's Portal", "Noble Portal"}
...
task.spawn(function() 
	pcall(function()
		...
		if queue_on_teleport then
			local UltraHubSCRIPT = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Peerapatllo/AA/main/NEW.lua"))()'
