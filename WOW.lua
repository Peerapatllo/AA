...
local exec = tostring(identifyexecutor())
--updatefix
local Window = Uilib.new(true, ""..namegame.." ( "..display .." ) ✅ GemFarm: " .. Settings.GemFramed .. " / " .. Settings.GemtoFarm .." ✅")
