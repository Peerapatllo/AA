...
local exec = tostring(identifyexecutor())
--updatefix
local Window = Uilib.new(true, "                         "..namegame.." ( "..display .." ) 🧙 Pain: " .. Settings.GemFramed .. " / " .. Settings.GemtoFarm .." 🧙")
